...
<link href="./install_files/styles.css" rel="stylesheet" type="text/css"
	media="screen">
...
<table align="center" cellpadding=2 cellspacing=7 class=normal width=70%
	...
	<TR>
		<TD colspan="2" class="subtitle">Database Configuration</TD>
	</TR>
	...
	else
	{
		?>
	<TR>
		<TD colspan="2" class="normal">The FlashChat installer needs some
		information about your database to finish the import. If you do not
		know this information, then please contact your website host or
		administrator. Please note that this is probably NOT the same as your
		FTP login information!</TD>
	</TR>
	<?
	...
	<tr>
		<td colspan=2 class="error_border"><font color="red"><?php echo @$errmsg; ?></font></td>
	</tr>
	<?
	if (!$link)
	{
		...
		?>
	<tr>
		<td colspan=2 class="error_border"><font color="red"><?echo @$errmsg;?></font></td>
	</tr>
	<?
	}
	?>
	<FORM action="config2db.php" method="post" align="center"
		name="installInfo">
	...
	<TR>
		...
		<TABLE width="100%" class="body_table" cellspacing="10" border="0">
			...
			<TR>
				<TD width="30%" align="right">Database Name:</TD>
				<TD><INPUT type="text" size="40" name="name" disabled
					value="<?php echo $dbname ?>" <?php if($useCMS) echo 'disabled';?>>
				</TD>
			</TR>
			<TR>
				<TD align="right">Database Host:</TD>
				<TD><INPUT type="text" size="40" name="host" disabled
					value="<?php echo $dbhost ?>" <?php if($useCMS) echo 'disabled';?>>
				</TD>
			</TR>

			<TR>
				<TD align="right">Table Prefix:</TD>
				<TD valign="top"><INPUT type="text" size="40" name="dbPrefix"
					disabled value="<?php echo $dbpref ?>"
					<?php if($useCMS) echo 'disabled';?>></TD>
			</TR>
			<TR>
				<TD colspan="2">This prefix will be prepended to any table names
				that the FlashChat installer creates. <?php if(! $useCMS ){?> You
				may leave this blank if desired. <?php }?></TD>
			</TR>
	...
	<TR>
		...
		?> <INPUT type="hidden" name="forcms" value="<?php echo $useCMS;?>"></TD>
	</TR>
	</FORM>
	<?}?>
</table>
